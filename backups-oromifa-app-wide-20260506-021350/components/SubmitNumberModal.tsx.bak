        ...
        <div className="mb-4 rounded-2xl border border-blue-100 bg-blue-50 p-4">
          ...
          <div className="space-y-2 text-sm text-blue-900">
            <div className="flex justify-between gap-3">
              <span className="font-semibold"><span className="text-lg font-extrabold" style={{ color: "#5A3A1A" }}>CBE</span></span>
              <span className="text-right font-mono"><span className="text-lg font-extrabold" style={{ color: "#5A3A1A" }}>1000251763646</span></span>
            </div>
            <div className="flex justify-between gap-3">
              <span className="font-semibold"><span className="text-lg font-extrabold" style={{ color: "#00A651" }}>Telebirr</span></span>
              <span className="text-right font-mono"><span className="text-lg font-extrabold" style={{ color: "#00A651" }}>0911121314</span></span>
            </div>
            <div className="flex justify-between gap-3">
